...
const projects: Project[] = [
  ...
  },
  {
    title: 'END. Clothing',
    category: 'E-Commerce',
    tags: ['Next.js', 'Fashion', 'Premium', 'Stripe'],
    desc: 'Global premium menswear & streetwear marketplace — exclusive launches, curated brands like Carhartt WIP, Arc\'teryx, Air Jordan, and a fully optimized shopping experience.',
    color: '#000000',
    url: 'https://www.endclothing.com/gb',
    image: '/portfolio/endclothing.png',
  },
  {
    title: 'StockX',
    category: 'E-Commerce',
    tags: ['React', 'Marketplace', 'Resale', 'Live Pricing'],
    desc: 'Global resale marketplace for sneakers, apparel, collectibles & trading cards — live bid/ask pricing, authentication, and Xpress Ship for verified items.',
    color: '#006340',
    url: 'https://stockx.com/',
    image: '/portfolio/stockx.png',
  },
  {
    title: 'Laced Up',
    category: 'E-Commerce',
